  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50">
      ...
      <header className="relative z-10 px-6 pt-12 pb-8">
        <nav className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="w-20 h-10 bg-gradient-to-br from-orange-500 to-amber-600 rounded-lg flex items-center justify-center p-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="8em" viewBox="0 0 112.918 40">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pb-20">
        <div className="text-center py-16">
          <div className={`transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
              Powered by <b>Clove Technologies Private Limited.</b><br />
              Revolutionize the cafeteria experience at Clove Technologies Private Limited with an intelligent, secure, and fully digital coupon management system designed exclusively for Clovains.
            </p>
        ...
        <div className="text-center mb-12">
          <h3 className="text-3xl font-bold text-gray-800 mb-4 mt-4">At Clove Technologies</h3>
          <p className="text-gray-600 text-lg">We empower Clovains with a seamless, secure, and fully digital Cafeteria Coupon Benefit system</p>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            { number: "300+", label: "Employees Benefited" },
            { number: "1000+", label: "Coupons Monthly" },
            { number: "99.9%", label: "Positive Support" },
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-600 text-center">
              © 2026 Clove Technologies Private Limited. <br />
              Developed By Yuva Subharam Vasamsetti - Built with ❤️ for better employee well-being.
            </div>
          </div>
        </div>
      </footer>
